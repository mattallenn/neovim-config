...
_G.packer_plugins = {
  ...
  onedark = {
    ...
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/onedark",
  ...
  ["vim-airline"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/vim-airline",
    url = "https://github.com/vim-airline/vim-airline"
  },
  ["vim-airline-themes"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/vim-airline-themes",
